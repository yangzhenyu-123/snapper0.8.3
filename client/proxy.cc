...
{
     y2err("now it is in  client/" << __FILE__ << "|| func name:" << __FUNCTION__ << "(num=" << num << ")");
...
{
     y2err("now it is in  client/" << __FILE__ << "|| func name:" << __FUNCTION__ << "(str=" << str << ")");
    istringstream s(str);
    unsigned int num = 0;
    s >> num;
...
{
     y2err("now it is in  client/" << __FILE__ << "|| func name:" << __FUNCTION__ << "(const str=" << str << ")");
    istringstream s(str);
    unsigned int num = 0;
    s >> num;
...
{
     y2err("now it is in  client/" << __FILE__ << "|| func name:" << __FUNCTION__ << "(str=" << str << "," << "delim=" << delim << ")");
