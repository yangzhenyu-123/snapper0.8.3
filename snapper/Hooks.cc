...
namespace snapper
{
    ...
    {
    y2err("now it is in  snapper/" << __FILE__ << "|| func name:" << __FUNCTION__ << "(" << subvolume << ", filesystem)");
    ...
    y2err("now it is in  snapper/" << __FILE__ << "|| func name:" << __FUNCTION__ << "#ifdef enable rollback");   
