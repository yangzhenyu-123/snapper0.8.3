...
namespace snapper
{
	...
	//y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(number_ignore=" << ignore_patterns.size() << ")");
    ...
    {
	//y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(dir=" << config_info->getSubvolume() <<")");
    ...
    {
	//y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(" << filesystem->openSubvolumeDir().fullname() << ")");
    ...
    {
	//y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(" << filesystem->openInfosDir().fullname() << ")");
    ...
    {
	//y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(num=" << snapshots.getSnapshotCurrent()->getNum() << ")");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(scd.uid=" << scd.uid << ", num=" << snapshots.getSnapshotCurrent()->getNum() << ")");
	...
	y2err("now it is in  snapper/" << __FILE__  << " now func is: " << __FUNCTION__ << "(parent=" << parent->getNum() << ", scd.uid=" << scd.uid<<")");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(num=" << snapshots.getSnapshotCurrent()->getNum() << ", scd.uid=" << scd.uid << ")");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__  << " now func is: " << __FUNCTION__ << "(pre=" << pre->getNum() << " , scd.uid=" << scd.uid << ")");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(snapshot, smd)");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(snapshot=" << snapshot->getNum() << ")");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__  << " || now func is: " << __FUNCTION__ << "(config_name=" << config_name << ", root_prefix=" << root_prefix << ")");
    ...
    {
		y2err("now it is in  snapper/" << __FILE__  << " || now func is: "<< __FUNCTION__ << "(path="  << SYSCONFIGFILE <<")");
    ...
    {
	y2err("now it is in  snapper/" << __FILE__ << " || now func is: " << __FUNCTION__ << "(" << config_name << ", " << root_prefix << ", " << subvolume << ", " << fstype << ", " << template_name << "） （begin)");
	...
	try
	{
	    ...
	    vector<string> config_names;
	    sysconfig.getValue("SNAPPER_CONFIGS", config_names);
		y2err("now it is in  snapper/" << __FILE__ << "|| now get sysconfig config_name: " << config_name);
		...
		y2err("now it is in  snapper/" << __FILE__ << "|| now add config_name to SNAPPER_CONFIGS");
	}
	catch (const FileNotFoundException& e)
	{
	...
	try
	{
		y2err("now it is in  snapper/" << __FILE__ << "|| now copy template_config then modify it !");
		y2err("now it is in  snapper/" << __FILE__ << "|| now 运行SysconfigFile构造函数!");
	...
	y2err("now it is in snapper/" <<  __FILE__ << " | func name: " << __FUNCTION__ << "(Snapper::end)");
    }
    ...
    {
	y2err("now it is in  snapper/"<< __FILE__ << " || now func is: " << __FUNCTION__ << "(" << config_name << ")");
    ...
    {
	y2err("now it is snapper/Snapshot.cc:" << " || now func is: " << __FUNCTION__);
