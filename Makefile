...
pkgdatadir = $(datadir)/snapper
pkgincludedir = $(includedir)/snapper
pkglibdir = $(libdir)/snapper
pkglibexecdir = $(libexecdir)/snapper
...
CONFIG_CLEAN_FILES = package/snapper.spec \
	dists/debian/snapper-Debian.dsc.in \
	dists/debian/snapper-xUbuntu.dsc.in
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/snapper.spec.in \
	$(top_srcdir)/dists/debian/snapper-Debian.dsc.in.in \
	$(top_srcdir)/dists/debian/snapper-xUbuntu.dsc.in.in AUTHORS \
...
ACLOCAL = ${SHELL} /root/snapper-0.8.3/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/snapper-0.8.3/missing autoconf
AUTOHEADER = ${SHELL} /root/snapper-0.8.3/missing autoheader
AUTOMAKE = ${SHELL} /root/snapper-0.8.3/missing automake-1.16
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -Wl,-rpath= -std=c99 -Wall -Wextra -Wformat -Wmissing-prototypes -Wno-unused-parameter
CHATTRBIN = /usr/bin/chattr
CHSNAPBIN = /sbin/chsnap
CPBIN = /bin/cp
CPP = gcc -E
CPPFLAGS = -I/root/boost/boost1.55-1.55.0+dfs -DCONFDIR='"/etc/sysconfig"'
CXX = g++
CXXCPP = g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -Wl,-rpath= -std=c++11 -Wall -Wextra -Wformat -Wnon-virtual-dtor -Wno-unused-parameter
CYGPATH_W = echo
...
LDFLAGS = -L/root/boost/boost1.55-1.55.0+dfs/stage/lib/
LIBOBJS = 
LIBS = 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIBVERSION_INFO = 10:0:6
LIBVERSION_MAJOR = 4
LIBVERSION_MINOR = 6
LIBVERSION_PATCHLEVEL = 0
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
LVCHANGEBIN = /sbin/lvchange
LVCREATEBIN = /sbin/lvcreate
LVMBIN = /sbin/lvm
LVREMOVEBIN = /sbin/lvremove
LVRENAMEBIN = /sbin/lvrename
LVSBIN = /sbin/lvs
MAKEINFO = ${SHELL} /root/snapper-0.8.3/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
abs_builddir = /root/snapper-0.8.3
abs_srcdir = /root/snapper-0.8.3
abs_top_builddir = /root/snapper-0.8.3
abs_top_srcdir = /root/snapper-0.8.3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/snapper-0.8.3/install-sh
...
# configure.ac) where 0.8.3 is expanded with the content of the toplevel
# VERSION file.
#
...
package/snapper.spec: $(top_builddir)/config.status $(srcdir)/snapper.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
dists/debian/snapper-Debian.dsc.in: $(top_builddir)/config.status $(top_srcdir)/dists/debian/snapper-Debian.dsc.in.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
dists/debian/snapper-xUbuntu.dsc.in: $(top_builddir)/config.status $(top_srcdir)/dists/debian/snapper-xUbuntu.dsc.in.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
